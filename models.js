...
const UserSchema = new mongoose.Schema({
  ...
  role: { 
    type: String, 
    enum: ['admin', 'requester', 'manager', 'technician', 'accounts', 'vendor', 'service_provider', 'super_admin', 'gate', 'receiving_officer', 'delivery_person', 'hod', 'staff'], 
    required: true 
  },
